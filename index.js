document.onscroll = reduceHeader;
...
const cards = [
  {
    ...
    body:
      "Eu non-col commodo accumsan anti mi. Commodo consectetur sed mi adipiscing accumsan ac nunc tincidunt lobortis",
  },
  {
    title: "Justo Placerat",
    body:
...
function reduceHeader() {
  ...
  header.style.paddingTop = window.scrollY < 50 ? "30px" : "15px";
}
